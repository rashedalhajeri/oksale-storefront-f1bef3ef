    ...
    <section className="relative w-full overflow-hidden pt-28 pb-20 bg-gradient-to-r from-oksale-50 to-indigo-50">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="flex flex-col-reverse md:flex-row-reverse items-center justify-between gap-12">
          ...
          >
            <div className="inline-flex items-center bg-white/90 backdrop-blur-sm rounded-full py-1.5 px-3 border border-indigo-100 mb-6 shadow-sm">
              <Sparkles className="w-4 h-4 text-oksale-600 ml-2" />
              <span className="text-sm font-medium text-oksale-800">متجرك الإلكتروني بسهولة وسرعة</span>
            </div>
            ...
            <div className="mt-12 grid grid-cols-2 gap-5">
              <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-sm border border-gray-100">
                <div className="flex items-center">
                  <div className="p-2 bg-oksale-50 rounded-lg ml-3">
                    <ShoppingBag className="w-5 h-5 text-oksale-600" />
                  </div>
                  <div>
                    <h3 className="font-medium text-gray-900">متجر احترافي</h3>
                    <p className="text-sm text-gray-500">تصميم مخصص لمتجرك</p>
                  </div>
                </div>
              </div>
              <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-sm border border-gray-100">
                <div className="flex items-center">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900">مدفوعات سهلة</h3>
