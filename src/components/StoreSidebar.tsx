...
const StoreSidebar = ({ 
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white p-4 rounded-xl shadow-sm border border-neutral-200">
        <h2 className="text-sm font-semibold mb-2 text-neutral-800">Popular Tags</h2>
      ...
      <div className="bg-gradient-to-br from-neutral-800 to-neutral-900 p-4 rounded-xl shadow-sm text-white">
        ...
        <div className="space-y-1.5">
          ...
          />
          <Button className="w-full bg-white text-neutral-800 hover:bg-white/90 h-8 text-xs">
            Subscribe
